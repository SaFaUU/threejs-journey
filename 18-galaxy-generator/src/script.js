...
gui.add(parameters, 'count').min(1).max(10000).step(1).onFinishChange(generateGalaxy)
...
gui.add(parameters, 'spin').min(0).max(2).step(0.01).onFinishChange(generateGalaxy)
